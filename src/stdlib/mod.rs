...
pub fn get_stdlib_tasks() -> HashMap<String, NativeFunc> {
    ...
    // --- env ---
    tasks.insert("env_get".into(), (|_, _| EvalResult::Value(Value::Void)) as NativeFunc);
    tasks.insert("env_set".into(), (|_, _| EvalResult::Value(Value::Void)) as NativeFunc);
    tasks.insert("env_keys".into(), (|_, _| EvalResult::Value(Value::Array(Arc::new(RefCell::new(vec![]))))) as NativeFunc);
